...
export default function HBCardFront({ suit, rank }: HBCardProps) {
  ...
  return (
    <svg height="150" width="110" style={{ margin: "2.5px", userSelect: "none" }}>
      ...
      {/*Center Pip*/         num % 2 === 1 ? <>
        <image href={colorData.pip} height="17.5%" x="37.5%" y="40%" filter="url(#outline)" />
      </> : undefined}
      {/*Top And Bottom Pip*/ num > 1 ? <>
        <image href={colorData.pip} height="12.5%" x="40.5%" y="20%" filter="url(#outline)" />
        <image href={colorData.pip} height="12.5%" x="40.5%" y="65%" filter="url(#outline)" />
      </> : undefined}
      {/*Left And Right Pip*/ num > 3 ? <>
        <image href={colorData.pip} height="12.5%" x="12.5%" y="42.5%" filter="url(#outline)" />
        <image href={colorData.pip} height="12.5%" x="67.5%" y="42.5%" filter="url(#outline)"/>
      </> : undefined}
